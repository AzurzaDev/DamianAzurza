  ...
  return (
    <div className="bg-gray-100 py-16 -mt-16 ">
      ...
      <p className="text-center text-gray-500 mb-12">
        Figma lorem component variant main layer. Create scrolling team bold
      ...
      <div className="flex flex-wrap justify-center gap-8">
        ...
        <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-lg w-60">
          ...
          <p className="text-gray-500 mt-2">
            Componente de ejemplo que describe la dirección musical de manera
            breve.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-lg w-60">
          ...
          <p className="text-gray-500 mt-2">
            Componente de ejemplo que describe la producción musical de manera
            breve.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-lg w-60">
          ...
          <p className="text-gray-500 mt-2">
            Componente de ejemplo que describe el servicio de solista de manera
            breve.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-lg w-60">
          ...
          <p className="text-gray-500 mt-2">
            Componente de ejemplo que describe el servicio de duetos de manera
            breve.
          </p>
        </div>
      </div>
